  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        ...
        transparent ? "bg-transparent pointer-events-none" : "bg-black/50",
        className
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-[10000] flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 p-6",
          side === "right" &&
